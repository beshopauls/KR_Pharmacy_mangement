...
try {
  ...
  $data = $db->query("SELECT * FROM viewcream")->fetchAll();
  if (!empty($_POST['add'])) {
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',2,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">CREAME</div>
      <div class="link">
        <a href="#">Admin </a>
