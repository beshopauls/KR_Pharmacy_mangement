...
try {
  ...
  $data = $db->query("SELECT * FROM viewpowder")->fetchAll();
  ...
  if (!empty($_POST['add'])) {
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',5,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<head>
  ...
  <link rel="stylesheet" href="css/powder.css">
  <!-- Font Awesome -->
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">POWDER</div>
      <div class="link">
        <a href="#">Admin </a>
      ...
      <div class="formtablets one" id="discountone">
        <div class="image">
          <div class="content">
            ...
            <p>Please enter full all data for this medicine
            </p>
