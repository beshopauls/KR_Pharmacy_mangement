...
try {
  ...
  $data = $db->query("SELECT * FROM viewliquid")->fetchAll();
  ...
  if (!empty($_POST['add'])) {
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',4,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">LIQUID</div>
      <div class="link">
        <a href="#">Admin </a>
