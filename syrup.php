...
try {
  ...
  $data = $db->query("SELECT * FROM viewsyrup")->fetchAll();
  ...
  if (!empty($_POST['add'])) {
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',3,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<head>
  ...
  <link rel="stylesheet" href="css/syrup.css">
  <!-- Font Awesome -->
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">SYRUP</div>
      <div class="link">
        <a href="#">Admin </a>
