...
try {
  ...
  $data = $db->query("SELECT * FROM viewampol")->fetchAll();
  if (!empty($_POST['add'])) {
    ...
    $manufacturer = htmlspecialchars($_POST['itype']);
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',7,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<head>
  ...
  <link rel="stylesheet" href="css/ampol.css">
  <!-- Font Awesome -->
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">AMPOL</div>
      <div class="link">
        <a href="#">Admin </a>
