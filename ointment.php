...
try {
  ...
  $data = $db->query("SELECT * FROM viewointment")->fetchAll();
  if (!empty($_POST['add'])) {
    $name = $_POST['iname'];
    ...
    $insert = $db->query("CALL PR_INSERT_INTO_MEDICINE('$name','$dosage','$price','$expirdate',NOW(),'$quantitybuy',$quantitybuy,'$minimumquantity',6,'$medcontent','$manufacturer')")->fetchAll();
  }
...
<head>
  ...
  <link rel="stylesheet" href="css/ointment.css">
  <!-- Font Awesome -->
...
<body>
  ...
  <div class="header">
    <div class="container">
      ...
      <div class="main-title medicine">OINTMENT</div>
      <div class="link">
        <a href="#">Admin </a>
      ...
      <div class="formtablets one" id="discountone">
        <div class="image">
          <div class="content">
            ...
            <p>Please enter all data required for this medicine
            </p>
